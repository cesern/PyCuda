...
r2 = r**2
nsteps=200
a0 = [ (Thot if i==j else Tcool) for i in range(nx) for j in range(ny) for k in range(nz) ]
...
im = ax.imshow(get_plane(u, z=7), cmap=plt.get_cmap('hot'), vmin=Tcool,vmax=Thot)
